...
format:
	...
	make execute-format FILENAME=./msx2-rpizero/src/entry.cpp
	make execute-format FILENAME=./msx2-rpizero/src/extern.h
	make execute-format FILENAME=./msx2-rpizero/src/mailbox.hpp
